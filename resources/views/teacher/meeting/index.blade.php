...
@section('content')
    <div class="row layout-top-spacing">
        <div class="col-12 d-flex justify-content-between">
            <a href="{{ route('zoom.refreshToken') }}" class="btn btn-success">Refresh Zoom Token</a>
            <a href="{{ route('teacher.meeting.create') }}" class="btn btn-primary">Add Meeting</a>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#zero-config').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('teacher.meeting.index') }}",
                "columns": [
                    {data: 'id', name: 'id'},
