...
@section('breadcrumbs')
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('teacher.studyMaterial.index') }}">Admin</a></li>
        ...
        <div id="flLoginForm" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form method="post" action="{{ route('teacher.studyMaterial.store') }}" name="form" class="row g-3" id="studyMaterialCreateForm" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#studyMaterialCreateForm').validate({
                rules: {
                    name: {
                        required: true
                    },
