        ...
        <div id="flLoginForm" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form method="post" action="{{ route('admin.student.update',$student) }}" name="form" class="row g-3" id="studentEditForm">
                        @method('put')
                        @csrf
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select" id="select-state" name="batch_ids[]" multiple placeholder="Select a cateogry..." autocomplete="off" class="form-select">
                                @php 
                                $selectedBatches = $student->batches->pluck('batch_id')->toArray();
                                @endphp
