        ...
        <div id="flLoginForm" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form method="post" action="{{ route('admin.teacher.update',$teacher) }}" name="form" class="row g-3" id="teacherEditForm">
                        @method('put')
                        @csrf
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select" id="select-state" name="batch_ids[]" multiple placeholder="Select a cateogry..." autocomplete="off" class="form-select">
                                @php 
                                $selectedBatches = $teacher->batches->pluck('batch_id')->toArray();
                                @endphp
